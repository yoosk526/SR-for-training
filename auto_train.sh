...
# python train.py --preload --lr  --step 10 --gamma 0.5 --epochs 
# python train.py --preload --lr  --step 20 --gamma 0.5 --epochs 
# python train.py --preload --lr  --step 30 --gamma 0.5 --epochs 
# python train.py --preload --lr  --step 40 --gamma 0.5 --epochs 
# python train.py --preload --lr  --step 50 --gamma 0.5 --epochs 
